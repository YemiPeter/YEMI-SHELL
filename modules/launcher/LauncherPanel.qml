            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        radius: 8
                        color: root.activeTab === 0 ? Qt.rgba(root.pywal.color5.r, root.pywal.color5.g, root.pywal.color5.b, 0.2) : "transparent"
                        ...
                        RowLayout {
                            ...
                            Text {
                                text: "󰀻"
                                color: root.activeTab === 0 ? root.pywal.color5 : root.pywal.color8
                                font.pixelSize: 14
                    ...
                    Rectangle {
                        ...
                        Layout.fillHeight: true
                        radius: 8
                        color: root.activeTab === 1 ? Qt.rgba(root.pywal.color13.r, root.pywal.color13.g, root.pywal.color13.b, 0.2) : "transparent"
                        Behavior on color { ColorAnimation { duration: 150 } }
                        RowLayout {
                            anchors.centerIn: parent
                            spacing: 6
                            Text {
                                text: "󰸉"
                                color: root.activeTab === 1 ? root.pywal.color13 : root.pywal.color8
                                font.pixelSize: 14
                                font.family: "JetBrainsMono Nerd Font"
                            }
                            Text {
            ...
            Item {
                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        border.color: root.pywal.color5
                        RowLayout {
                            anchors.fill: parent
                            ...
                            delegate: Rectangle {
                                ...
                                color: {
                                    if (index === root.selectedIndex)
                                        return Qt.rgba(root.pywal.color5.r, root.pywal.color5.g, root.pywal.color5.b, 0.2)
                                ...
                                RowLayout {
                                    ...
                                    ColumnLayout {
                                        ...
                                        Text {
                                            Layout.fillWidth: true
                                            text: modelData.name
                                            color: index === root.selectedIndex ? root.pywal.color5 : root.pywal.foreground
                                            font.pixelSize: 13
                                            font.family: "JetBrainsMono Nerd Font"
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            Text { text: "↑↓ nav"; color: root.pywal.color8; font.pixelSize: 10; font.family: "JetBrainsMono Nerd Font"; opacity: 0.7 }
                            Item { Layout.fillWidth: true }
                            Text { text: "↵ launch"; color: root.pywal.color8; font.pixelSize: 10; font.family: "JetBrainsMono Nerd Font"; opacity: 0.7 }
                            Item { Layout.fillWidth: true }
                            Text { text: "tab walls"; color: root.pywal.color8; font.pixelSize: 10; font.family: "JetBrainsMono Nerd Font"; opacity: 0.7 }
                            Item { Layout.fillWidth: true }
                            Text { text: "esc close"; color: root.pywal.color8; font.pixelSize: 10; font.family: "JetBrainsMono Nerd Font"; opacity: 0.7 }
                        }
                    }
                }
                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        border.color: root.pywal.color13
                        RowLayout {
                            anchors.fill: parent
                            anchors.leftMargin: 14
                            anchors.rightMargin: 14
                                ...
                                Rectangle {
                                    ...
                                    color: {
                                        if (index === root.wallSelectedIndex)
                                            return Qt.rgba(root.pywal.color13.r, root.pywal.color13.g, root.pywal.color13.b, 0.25)
                                    ...
                                    border.color: modelData.path === root.currentWallpaper ? root.pywal.color2 : root.pywal.color13
                                    Behavior on color { ColorAnimation { duration: 120 } }
                                    ColumnLayout {
                                        anchors.fill: parent
                                        anchors.margins: 4
                                        ...
                                        Text {
                                            ...
                                            text: modelData.name
                                            color: {
                                                if (modelData.path === root.currentWallpaper) return root.pywal.color2
                                                if (index === root.wallSelectedIndex) return root.pywal.color13
                                                return root.pywal.foreground
                                            }
                                            font.pixelSize: 8
                                            font.family: "JetBrainsMono Nerd Font"
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            Text { text: "←→↑↓ nav"; color: root.pywal.color8; font.pixelSize: 10; font.family: "JetBrainsMono Nerd Font"; opacity: 0.7 }
                            Item { Layout.fillWidth: true }
                            Text { text: "↵ apply"; color: root.pywal.color8; font.pixelSize: 10; font.family: "JetBrainsMono Nerd Font"; opacity: 0.7 }
                            Item { Layout.fillWidth: true }
                            Text { text: "tab apps"; color: root.pywal.color8; font.pixelSize: 10; font.family: "JetBrainsMono Nerd Font"; opacity: 0.7 }
                            Item { Layout.fillWidth: true }
                            Text { text: "esc close"; color: root.pywal.color8; font.pixelSize: 10; font.family: "JetBrainsMono Nerd Font"; opacity: 0.7 }
                        }
                    }
