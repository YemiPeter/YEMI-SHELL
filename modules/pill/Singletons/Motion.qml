...
/**
 * Animation timing constants and easing curves for the pill morph system.
 * Durations scale with reduceMotion preference for accessibility.
 */
Singleton {
    // ADAPTED: no import "Singletons" needed — same module namespace
