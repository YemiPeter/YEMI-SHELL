...
> **STATUS: ✅ EXECUTED 2026-09-04** — W1+W2 shipped as one commit-pair,
> W3–W4 validated (exit 0 on `x1lxjo` warm-dark, `k8l167` grayscale canary,
> live `og28j9`; B-canary 0.0000 sat on grayscale), palette regenerated live
> via `after-wall.sh` (terminal fan-out + IPC reload done). W5 diff captured in
> audits/06 §5 "Fix 1B". Fix 2 (`Appearance.qml` guard) shipped alongside.
