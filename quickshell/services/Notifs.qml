...
Singleton {
    ...
    // iNiR compatibility aliases
    readonly property alias silent: root.dnd
    readonly property alias count: root._notifCount
    readonly property int _notifCount: root.activeNotifications.length
