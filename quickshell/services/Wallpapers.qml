...
Singleton {
    ...
    readonly property bool autoWallpaperGenerateColors: QsSingletons.Flags.autoWallpaperGenerateColors
    readonly property string autoWallpaperFolder: QsSingletons.Flags.autoWallpaperFolder
