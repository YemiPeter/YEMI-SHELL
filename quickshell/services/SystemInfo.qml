...
/**
 * Provides static system identity: distro, user, session and resource links.
 * Parsed from /etc/os-release plus the local user database. Self-contained —
 * no Config/common deps, safe to run on any distro.
 */
Singleton {
    id: root
    ...
    Timer {
        ...
        onTriggered: {
            ...
            // Friendly name (PRETTY_NAME, fallback to NAME minus "Linux")
