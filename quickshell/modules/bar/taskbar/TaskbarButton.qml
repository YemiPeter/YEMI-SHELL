...
// A single running-app icon button for the bar taskbar. Minimal: icon,
// hover highlight, active indicator dot, click to focus.
Item {
    id: btn
    ...
    // Fallback disc when icon cannot be resolved
    Rectangle {
        anchors.centerIn: parent
