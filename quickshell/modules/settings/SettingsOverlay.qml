...
Scope {
    ...
    { name: Translation.tr("Quick"),      shortName: "",  icon: "instant_mix",  desc: Translation.tr("Wallpaper & quick tweaks"),   essential: true,  component: Quickshell.shellPath("modules/settings/QuickConfig.qml")        },
    { name: Translation.tr("System"),     shortName: "",  icon: "browse",       desc: Translation.tr("Audio, battery, language, lock"), essential: true,  component: Quickshell.shellPath("modules/settings/GeneralConfig.qml")       },
    // Bar (page 2) removed - pill-only config
    { name: Translation.tr("Background"), shortName: "",  icon: "texture",      desc: Translation.tr("Parallax, effects, backdrop"),  essential: false, component: Quickshell.shellPath("modules/settings/BackgroundConfig.qml")      },
    { name: Translation.tr("Themes"),     shortName: "",  icon: "palette",      desc: Translation.tr("Colors, fonts, styles"),        essential: true,  component: Quickshell.shellPath("modules/settings/ThemesConfig.qml")        },
    // Panels (page 5) removed - dock/sidebar bar-only config
    { name: Translation.tr("Tools"),      shortName: "",  icon: "build",        desc: Translation.tr("Recording, crosshair, overlays"), essential: false, component: Quickshell.shellPath("modules/settings/ToolsConfig.qml")        },
    { name: Translation.tr("Services"),   shortName: "",  icon: "settings",     desc: Translation.tr("Weather, AI, apps"),            essential: false, component: Quickshell.shellPath("modules/settings/ServicesConfig.qml")      },
    { name: Translation.tr("Advanced"),   shortName: "",  icon: "construction", desc: Translation.tr("Color gen, performance"),       essential: false, component: Quickshell.shellPath("modules/settings/AdvancedConfig.qml")     },
    { name: Translation.tr("Shortcuts"),  shortName: "",  icon: "keyboard",     desc: Translation.tr("Keybindings reference"),        essential: true,  component: Quickshell.shellPath("modules/settings/CheatsheetConfig.qml")    },
    // Modules (page 10) removed  - module enable/disable bar-only config
    // Waffle Style (page 11) removed  - win11 taskbar bar-only config
    // Compositor/Niri (page 12) removed  - compositor-specific config
    { name: Translation.tr("About"),      shortName: "",  icon: "info",         desc: Translation.tr("Version & credits"),            essential: true,  component: Quickshell.shellPath("modules/settings/About.qml")              },
    { name: Translation.tr("Widgets"),    shortName: "",  icon: "widgets",      desc: Translation.tr("Clock, weather, media, custom"), essential: false, component: Quickshell.shellPath("modules/settings/DesktopWidgetsConfig.qml") },
    { name: Translation.tr("Monitors"),   shortName: "",  icon: "display_settings", desc: Translation.tr("Per-monitor shell visibility"), essential: true, component: Quickshell.shellPath("modules/settings/MonitorVisibilityConfig.qml") },
    { name: Translation.tr("Bar"),        shortName: "",  icon: "toast",        desc: Translation.tr("Position, tray, modules"),      essential: true,  component: Quickshell.shellPath("modules/settings/BarConfig.qml")              },
    { name: Translation.tr("Interface"),  shortName: "",  icon: "view_module",  desc: Translation.tr("Media, radio, clocks, custom"), essential: false, component: Quickshell.shellPath("modules/settings/PanelsConfig.qml")              },
    { name: Translation.tr("Modules"),    shortName: "",  icon: "extension",    desc: Translation.tr("Enable/disable panels, scaling"),essential: false, component: Quickshell.shellPath("modules/settings/ModulesConfig.qml")            },
    { name: Translation.tr("Waffle Style"), shortName: "", icon: "window",     desc: Translation.tr("Win11-style taskbar"),        essential: false, component: Quickshell.shellPath("modules/settings/WaffleConfig.qml")              },
    { name: Translation.tr("Compositor"), shortName: "",  icon: "desktop_windows", desc: Translation.tr("Display, input, layout, Niri"), essential: false, component: Quickshell.shellPath("modules/settings/NiriConfig.qml") }
    ]
