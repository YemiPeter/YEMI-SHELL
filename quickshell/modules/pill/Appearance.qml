...
SettingsSurface {
    ...
    // iNiR fluent icons (committed to assets/icons) — used for the Bar nav row.
    ...
    Column {
        ...
        SettingsRow {
            ...
            surface: root
            captionOnFocus: true
            sourceIcon: root.icRoot + "task-view-light.svg"
            ...
            GlyphIcon {
                ...
                height: 16 * root.s
                name: "chevron-right"
                color: root.focusRowItem === pillsRow ? Theme.cream : Theme.iconDim
                stroke: 1.9
            }
        }
