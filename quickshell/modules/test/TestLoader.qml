...
QtObject {
    ...
    // Use absolute filesystem path to settings directory
    property string settingsPath: "file:///home/yemi/.config/quickshell/settings/"
    ...
    function loadNext() {
        if (current >= pages.length) {
            ...
            Quickshell.ipc.notify("test", "Passed: " + passed + "/" + pages.length + ", Failed: " + failed + "/" + pages.length)
            return
        }
        ...
        try {
            var fullPath = settingsPath + page
